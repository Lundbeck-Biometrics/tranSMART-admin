<div style="text-align: center;">
    <div class="welcome"
        ...
        <p>The <b>GWAS</b> tab allows you to discover GWAS and eQTL datasets made available through tranSMART.
        </p>
        <br/>
        <p>Note: You are currently accessing our sandbox environment, which is work in progress. This means that the tranSMART service might be down from time to time while we are enabling new features for you to use!</p>
