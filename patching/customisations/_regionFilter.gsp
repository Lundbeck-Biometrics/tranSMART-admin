...
<br/><br/> <br/>
Use: <g:select name="filterGeneUse" from="${['38':'HG38']}" optionKey="${{it.key}}" optionValue="${{it.value}}"/>
<br/><br/>
Location: 
...
Use: <g:select name="filterChromosomeUse" from="${['38':'HG38']}" optionKey="${{it.key}}" optionValue="${{it.value}}"/>
<br/><br/>
Position: 
